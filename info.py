...
API_ID = int(environ.get('API_ID', '7506896'))
API_HASH = environ.get('API_HASH', 'a7fe67d6616c957e0e488ce910aeaadb')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/4822421a403c7cb110c61-5d320c62d53c99c9f7.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1059586105').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1059586105').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003624969886'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003610940961 -1003193032701 -1003827919912 -1003779826671 -1003779159067').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003600503921 -1001555967163') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1001874426493')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003176716094')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://diginprasadofficial_db_user:D9YND3dLvFGcfQc0@cluster0.jicpiqq.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "testbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'testcollection')
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'vibeflix_animehub') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/anime_24hr')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+r6hfZicxDKxjOTRl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'anime_24hr') # Support Chat Link Without https:// or @
